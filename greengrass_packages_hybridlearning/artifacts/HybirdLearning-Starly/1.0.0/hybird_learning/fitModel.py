...
#from keras.layers import Dense, LSTM, Dropout, GRU, SimpleRNN, Convolution1D, MaxPooling1D, Flatten
...
def lstm(p_lag, dataFrame, model_path):
    ...
    '''model = load_model(model_path+"/modelOt_avg.json",model_path+"/weightsOt_avg.npy")
