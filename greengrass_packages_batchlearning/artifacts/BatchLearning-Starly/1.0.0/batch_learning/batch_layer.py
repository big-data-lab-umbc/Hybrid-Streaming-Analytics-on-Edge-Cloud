...
def recordstream(df, epoch_id):
    ...
    if len(dfp.take(1)) != 0:
        df_final,lrModels = lstm(2,dfp,g_model)
...
g_model = '/home/pi/Downloads/greengrass_packages_edgetocloud_hybridlearning/artifacts/EdgeToCloud-HybirdLearning-Starly/1.0.0/edgetocloud_hybird_learning/sample_model/Ot_avg.tflite'
